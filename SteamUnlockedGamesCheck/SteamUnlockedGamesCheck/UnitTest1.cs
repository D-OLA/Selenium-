...
namespace SteamUnlockedGamesCheck
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMethod1()
        {
            ...
            By SteamLink = By.XPath("/html[1]/body[1]/div[7]/div[1]/div[11]/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/a[1]/h3[1]");
            ...
            webDriver.FindElement(SteamUnlockedSearch).SendKeys("cyberpunk");
            webDriver.FindElement(SteamUnlockedSearch).SendKeys(Keys.Enter);
            Thread.Sleep(waitTime2);

            webDriver.FindElement(SteamUnlockedSearch).SendKeys("WWE");
            webDriver.FindElement(SteamUnlockedSearch).SendKeys(Keys.Enter);
            Thread.Sleep(waitTime2);
